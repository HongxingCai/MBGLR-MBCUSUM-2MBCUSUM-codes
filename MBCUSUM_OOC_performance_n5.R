...
# 3. Prior parameters
# ==========================================================
# For n = 5, Table 6 uses m0 = (0.3, 0.3)'.
...
# Control limits for n = 5 in Table 6
H_values <- c(
  2.6473,
  2.9250,
  2.9921,
...
print("SSATS1 matrix for MBCUSUM, n = 5:")
print(round(SSATS_mat, 2))

print("SSSDTS matrix for MBCUSUM, n = 5:")
print(round(SSSDTS_mat, 2))

write.csv(
  results_long,
  file = "MBCUSUM_OOC_performance_n5_long_results.csv",
  row.names = FALSE
)

write.csv(
  SSATS_mat,
  file = "MBCUSUM_OOC_performance_n5_SSATS1_matrix.csv"
)

write.csv(
  SSSDTS_mat,
  file = "MBCUSUM_OOC_performance_n5_SSSDTS_matrix.csv"
)
